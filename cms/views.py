...
def cms_home(request):
    if request.session.has_key('username'):
        ...
        return render(request, 'cms/dashboard.html', {'all_customer': all_customer,  'collect_amount': collect_month_amount, 'collect_total_amount': collect_annual_amount, 'collection_chart': collection_chart, 'all_hawker': all_hawker, 'username': username})
